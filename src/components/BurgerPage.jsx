...
function BurgerPage({burgerContent, setBurgerContent, currentPage, setCurrentPage}) {
    return (
        <div>
                                ...
                                <div className="left_header_titles">
                                    <div>
                                        <p onClick={() => {
                                            ...
                                            setCurrentPage(0);
                                        }} style={{color: `${currentPage === 0 ? '#29B85D' : '#000'}`}}>Bosh sahifa</p>
                                        <p onClick={() => {
                                            setBurgerContent(false);
                                            setCurrentPage(1);
                                        }} style={{color: `${currentPage === 1 ? '#29B85D' : '#000'}`}}>Biz haqimizda</p>
                                        <p onClick={() => {
                                            setBurgerContent(false);
                                            setCurrentPage(2);
                                        }} style={{color: `${currentPage === 2 ? '#29B85D' : '#000'}`}}>Xizmatlar</p>
                                        <p onClick={() => {
                                            setBurgerContent(false);
                                            setCurrentPage(3);
                                        }} style={{color: `${currentPage === 3 ? '#29B85D' : '#000'}`}}>Portfolio</p>
                                        <p onClick={() => {
                                            setBurgerContent(false);
                                            setCurrentPage(4);
                                        }} style={{color: `${currentPage === 4 ? '#29B85D' : '#000'}`}}>Biz bilan aloqa</p>
                                    </div>
                                </div>
