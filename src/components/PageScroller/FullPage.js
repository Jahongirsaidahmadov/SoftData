...
import FirstComponent from '../Homepage.jsx'
import SecondComponent from '../AboutPage.jsx'
import ThirdComponent from '../ServicePage.jsx'
import FourthComponent from '../PortfolioPage.jsx'
import FifthComponent from '../ContactPage.jsx'
...
export default function FullPage({ currentPage, setCurrentPage, burgerContent, setBurgerContent }) {
  ...
  return (
    <React.Fragment>
      ...
      <Pager className="Pager-additional-class fixed_Pager">
        {/* {pagesNumbers} */}
